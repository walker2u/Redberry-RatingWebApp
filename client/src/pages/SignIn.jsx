...
const SignIn = () => {
    ...
    return (
        <div className="h-full w-full flex flex-col items-center justify-center bg-red-100">
            <div className="flex justify-center">
                <img src="../public/images/logo.png" alt="Logo" className="h-28 w-h-28 object-contain" />
            </div>
